...
//go:generate mockgen -destination mock_store.go -package store github.com/clin211/miniblog-v2/internal/apiserver/store IStore,UserStore,PostStore,ConcretePostStore
...
func (store *datastore) Category() CategoryStore {
